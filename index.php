...
<head>
  ...
  <title>American Montessori Leadership Academy</title>
            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 text-center slider-text">
                <div class="slider-text-inner">
                  ...
                  <h2>
                    Brought to you by
                    <a href="#" target="_blank">Group A IPMC Software Engineers
                    </a>
                  </h2>
                  <p>
                    <a class="btn btn-primary btn-lg" href="#">Start Learning Now!</a>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 text-center slider-text">
                <div class="slider-text-inner">
                  ...
                  <h2>
                    Brought to you by
                    <a href="#" target="_blank">Group A</a>
                  </h2>
                  <p>
            ...
            <div class="owl-carousel owl-carousel-fullwidth">
              ...
              <div class="item">
                <div class="testimony-slide active text-center">
                  ...
                  <blockquote>
                    <p>
                      &ldquo;Far from the countries Vokalia and Consonantia,
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2 animate-box">
        <div class="date-counter text-center">
          ...
          <p>
            <a href="#" class="btn btn-primary btn-lg btn-reg">Register Now!</a>
          </p>
        </div>
      </div>
    </div>
